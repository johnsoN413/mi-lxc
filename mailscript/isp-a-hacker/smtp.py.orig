...
send_mail('smtp.isp-a.milxc', 587, 'Admin<admin@target.milxc>', ['user@gcorp.milxc'],token+' Test 4 from hacker',"Email problématique car on essaye d'usurper l'adresse d'Admin. Ne doit pas être reçu.\nFrom : admin@target.milxc\nTo : user@gcorp.milxc\nServeur : isp-a.milxc\nPort : 587\nMachine : isp-a.hacker")
send_mail('smtp.target.milxc', 25, 'Hacker<hacker@isp-a.milxc>', ['user@gcorp.milxc'],token+' Test 5 from hacker',"Email problématique car on essaye de se connecter directement depuis Hacker sur le port 25 du serveur smtp de target. Ne doit pas être reçu.\nFrom : admin@target.milxc\nTo : user@gcorp.milxc\nServeur : isp-a.milxc\nPort : 587\nMachine : isp-a.hacker")
